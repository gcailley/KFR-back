...
class RtlqPhoto extends AbstractRtlqEntity
{
     ...
     * @var integer 
     * 
     * @ORM\ManyToOne(targetEntity="RoutanglangquanBundle\Entity\Association\RtlqPhotoDirectory", cascade={"persist"})
    ...
    /**
     *
     * @var string @ORM\Column(name="source_base64", type="blob", nullable=true)
     */
    private $source_base64;
    /**
     *
     * @var string @ORM\Column(name="source_mime_type",  type="string", length=20, nullable=true)
     */
    private $source_mime_type;
    
    /**
     *
     * @var string @ORM\Column(name="source_file_size",  type="string", length=20, nullable=true)
     */
    ...
    /**
     *
     * @var string @ORM\Column(name="thumbnail_base64", type="blob", nullable=true)
     */
    private $thumbnail_base64;

    /**
     *
     * @var string @ORM\Column(name="thumbnail_mime_type",  type="string", length=20, nullable=true)
     */
    private $thumbnail_mime_type;

    /**
     *
     * @var string @ORM\Column(name="thumbnail_file_size",  type="string", length=20, nullable=true)
     */
